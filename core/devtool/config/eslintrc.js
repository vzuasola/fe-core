...
module.exports = {
    ...
    globals: {
        ...
        iapiKeepAlive: true,
        iapiValidateTCVersion: true,
        iapiConf: true,
        iapiRequestTemporaryToken: true,
        iapiSetClientPlatform: true,
        iapiSetClientUrl: true,
        iapiSetDeviceType: true,
        iapiAddUrlParams: true,
        iapiLoginModeFlash: true,
        iapiValidatePasswordChange: true,
        iapiClientParams: true,
        fimReady:true,
        ...
        DocumentTouch: true,
        grOnlineLoader: true,
        iapiLoginUsernameExternalToken: true
    },
    parser: "babel-eslint",
    rules: {
        // Possible Errors
