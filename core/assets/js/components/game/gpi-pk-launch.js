...
function GpiPkLauncher() {
    ...
    function launchGame() {
        var loaderUrl = utility.url('/game/loader'),
            uri = utility.url('/game/gpipk/lobby'),
            windowObject = '';

        windowObject = PopupWindow(loaderUrl, 'GPIPkGame', {width: 1050, height: 600});
        setTimeout(function () {
...
GpiPkLauncher.prototype = GameLaunch.prototype;

export default GpiPkLauncher;
