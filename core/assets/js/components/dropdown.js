...
Dropdown.prototype.setActive = function (target) {
    ...
    utility.forEachElement($this.options.selector, function (buttonElem, index) {
        var dropdownItem = $this.dropdownContents[index],
            ...
            dropdownTarget = (target === dropdownItem ||
                (target.parentNode && target.parentNode === dropdownItem) ||
                (target.parentNode && target.parentNode.parentNode && target.parentNode.parentNode === dropdownItem)) ? dropdownItem : null;
