(function (root, factory) {
    ...
    var defaults = {
        ...
        dropdownEventIn:            "click", // event to trigger to show/display dropdown
        dropdownEventOut:           "click", // event to trigger to remove/hide dropdown
    ...
    priorityNav.doesItFit = function (_this) {
        ...
        (debounce(function () {
            ...
            if (_this.querySelector(mainNav).children.length < 1) {
                ...
                if (_this.querySelectorAll('.priority-nav__wrapper li.active').length > 0) {
                    //highlight the more dropdown selector
                    _this.querySelector(navDropdownToggle).classList.add("active");
                }
            }
    ...
    var listeners = function (_this, settings) {
        ...
        // Toggle dropdown
        _this.querySelector(navDropdownToggle).addEventListener(settings.dropdownEventIn, function () {
         ...
         */
        document.addEventListener(settings.dropdownEventOut, function (event) {
