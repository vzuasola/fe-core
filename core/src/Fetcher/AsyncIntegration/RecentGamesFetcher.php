...
class RecentGamesFetcher extends AbstractIntegration
{
    ...
    public function getRecents()
    {
        ...
        return $this->createRequest($this->client, 'GET', "$this->host/games/recent", $options, $callback);
    }
    ...
    public function saveRecents(array $data, $timestamp = null)
    {
        ...
        try {
            ...
            $response = $this->request('PUT', "$this->host/games/recent", [
                'cookies' => $cookieJar,
                'json' => $array,
            ]);
    ...
    public function removeRecents(array $data)
    {
        ...
        try {
            $response = $this->request('DELETE', "$this->host/games/recent", [
                'cookies' => $cookieJar,
                'json' => $data,
            ]);
        } catch (GuzzleException $e) {
