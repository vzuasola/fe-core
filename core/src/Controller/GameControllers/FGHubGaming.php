...
class FGHubGaming extends BaseController
{
    ...
    public function getGameLobby($request, $response)
    {
        ...
        try {
            ...
            $responseData = $this->provider->getLobby('icore_fghub', [
                'options' => $options
            ]);
    ...
    public function getGameUrl($request, $response, $args)
    {
        ...
        try {
            ...
            $responseData = $this->provider->getGameUrlById('icore_fghub', $args['gameid'], [
                'options' => [
