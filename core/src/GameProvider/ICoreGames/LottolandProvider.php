...
/**
 * Provider Class for Lottoland
 */
class LottolandProvider implements GameProviderInterface
{
    /**
     * Lottoland game code definition
     */
    const KEY = 'lottoland';
    ...
    */
    ...
    public function init(RequestInterface $request, ResponseInterface $response)
    {
        ...
        try {
            ...
            if ($isLogin && $config) {
                ...
                $this->scripts->attach([
                    self::KEY => [
                        'currencies' => $config[self::KEY . '_currency'],
                        'languages' => $config[self::KEY . '_language_mapping'],
                    ],
                ]);
            }
    ...
    public function getJavascriptAssets()
    {
        ...
        return [
            $config[self::KEY . '_javascript_assets']
        ];
    }
}
